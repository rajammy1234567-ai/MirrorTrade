...
const ROUTE_CATALOG = [
  ...
  { method: "PATCH", path: "/api/admin/users/:id/status", access: "admin" },
  { method: "POST", path: "/api/admin/users/:id/deposit", access: "admin" },
  { method: "GET", path: "/api/admin/deposits", access: "admin" },
  { method: "POST", path: "/api/admin/deposits/:id/approve", access: "admin" },
  { method: "POST", path: "/api/admin/deposits/:id/reject", access: "admin" },
  { method: "GET", path: "/api/admin/withdrawals", access: "admin" },
  { method: "POST", path: "/api/admin/withdrawals/:id/pay", access: "admin" },
